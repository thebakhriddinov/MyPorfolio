...
export default function Header() {
    return (
        <header className="bg-[#01041A] w-[90vw] ml-auto mr-auto pt-10 lg:pt-15 flex justify-center items-center">
            <ul className="z-10 bg-[#01041A] w-[90vw] md:w-113 md:h-16.5 lg:font-medium md:bg-[#0B0D22] flex justify-around items-center text-[#C1C2D3] rounded-[13px] border-2 border-[#1B1E33] h-14 ">
                <button 
